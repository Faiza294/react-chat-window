  ...
  Message.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('div', { className: 'sc-message--avatar avatar-tooltip', style: {
            backgroundImage: 'url(' + this.props.message.imageUrl + ')'
          } }, _react2.default.createElement('span', { className: 'tooltiptext' }, this.props.message.userName) ),
